  ...
  <body>
    ...
    <div class="container main-container">
      <div class="col-md-12">
        ...
        <div class="h-10"></div>
        <form action="addresult.php" method="post" enctype="multipart/form-data" autocomplete="off">
          <div class="row">
            <div class="col-md-6">
              <div class="input-contact"required>
                <select name='companyName' style='width:100%; height:100%; border: 0; padding: 0 20px; float: left; position: relative; background-color: transparent; z-index: 0; font-size: 14px; color: #9a9a9a;'>
                  ...
                  <option value=<?php $name=$row['UserID']; echo "\"$name\"";?>><?php echo $row['UserID'];?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
